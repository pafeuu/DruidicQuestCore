...
public class NatureMissileProjectile extends AbstractMagicProjectile {
    public NatureMissileProjectile(EntityType<? extends NatureMissileProjectile> entityType, Level level) {
        super(entityType, level);
        this.setNoGravity(true);
    }

    public NatureMissileProjectile(Level levelIn, LivingEntity shooter) {
        this(EntityRegistry.NATURE_MISSILE_PROJECTILE.get(), levelIn);
        setOwner(shooter);
    }
    ...
    public Optional<Supplier<SoundEvent>> getImpactSound() {
        return Optional.of(BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.AMETHYST_BLOCK_CHIME));
    }
    ...
    public void trailParticles() {
        ...
        for (int j = 0; j < steps; j++) {
            ...
            level().addParticle(ParticleTypes.HAPPY_VILLAGER, true, x, y, z, jitter.x, jitter.y, jitter.z);
        }
    }
}